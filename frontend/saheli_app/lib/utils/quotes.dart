...
List<String> articleTitle = [
  ...
  "The best thing you can have is confidence.",
  "Women are the real architects of society.",
  "A queen is not afraid to fail."
];
List<String> imageSliders = [
  // "https://www.freepik.com/free-photo/front-view-strong-woman-flexing-her-biceps_7451064.htm#query=strong%20woman&position=0&from_view=keyword&track=ais&uuid=9d8b38d0-12dd-4bd9-9a3e-efff72c13c6b"
